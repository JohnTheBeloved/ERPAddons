...
var woo_notification = {
    ...
    close_notify: function() {
        jQuery("#notify-close").unbind(), jQuery("#notify-close").bind("click", function() {
            woo_notification.message_hide(), jQuery("#message-purchased").unbind(), parseInt(woo_notification.time_close) > 0 && woo_notification.setCookie("woo_notification_close", 1, 3600 * parseInt(woo_notification.time_close))
        })
    },
    random: function(e, t) {
