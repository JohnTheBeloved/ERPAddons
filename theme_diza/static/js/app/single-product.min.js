...
jQuery(function(l) {
    ...
    l("body").on("init", ".wc-tabs-wrapper, .woocommerce-tabs", function() {
        l(this).find(".wc-tab, .woocommerce-tabs .panel:not(.panel .panel)").hide();
        var t = window.location.hash,
            e = window.location.href,
            i = l(this).find(".wc-tabs, ul.tabs").first();
        ...
        i.find(".wc-tabs, ul.tabs").find("li").removeClass("active"),
            ...
            i.find(e).show() //replaced i.find(e.attr("href")).show()
    }).on("click", "a.woocommerce-review-link", function() {
        return l(".reviews_tab a").click(), !0
    }).on("init", "#rating", function() {
        l("#rating").hide().before('<p class="stars">\t\t\t\t\t\t<span>\t\t\t\t\t\t\t<a class="star-1" href="#">1</a>\t\t\t\t\t\t\t<a class="star-2" href="#">2</a>\t\t\t\t\t\t\t<a class="star-3" href="#">3</a>\t\t\t\t\t\t\t<a class="star-4" href="#">4</a>\t\t\t\t\t\t\t<a class="star-5" href="#">5</a>\t\t\t\t\t\t</span>\t\t\t\t\t</p>')
    }).on("click", "#respond p.stars a", function() {
        var t = l(this),
            e = l(this).closest("#respond").find("#rating"),
            i = l(this).closest(".stars");
        return e.val(t.text()), t.siblings("a").removeClass("active"), t.addClass("active"), i.addClass("selected"), !1
    }).on("click", "#respond #submit", function() {
        var t = l(this).closest("#respond").find("#rating"),
            e = t.val();
    ...
    }), l(".wc-tabs-wrapper, .woocommerce-tabs, #rating").trigger("init");
    var e = function(t, e) {
    ...
    e.prototype.initFlexslider = function(t) {
        ...
        e.flexslider(o), l(".woocommerce-product-gallery__wrapper .woocommerce-product-gallery__image:eq(0) .wp-post-image").one("load", function() {
            var i = l(this);
        ...
        l(t).each(function(t, e) {
            if (l(e).find("img").data("large_image_width") > i) return !(o = !0)
        }), o && (e = l.extend({
            touch: !1
        ...
        return 0 < t.length && t.each(function(t, e) {
            var i, o, a, r, s = l(e).find("img");
            s.length && (i = s.attr("data-large_image"), o = s.attr("data-large_image_width"), a = s.attr("data-large_image_height"), r = {
                alt: s.attr("alt"),
                src: i,
                w: o,
                h: a,
                title: s.attr("data-caption") ? s.attr("data-caption") : s.attr("title")
            }, n.push(r))
        }), n
        ...
        var e = l(".pswp")[0],
            ...
            o = l(t.target),
            a = o.is(".woocommerce-product-gallery__trigger") || o.is(".woocommerce-product-gallery__trigger img") ? this.$target.find(".flex-active-slide") : o.closest(".woocommerce-product-gallery__image"),
            r = l.extend({
                index: l(a).index(),
    ...
    }, l.fn.wc_product_gallery = function(t) {
        console.log(932, t)
        return new e(this, t || wc_single_product_params), this
    }, l(".woocommerce-product-gallery").each(function() {
        l(this).trigger("wc-product-gallery-before-init", [this, wc_single_product_params]), l(this).wc_product_gallery(wc_single_product_params), l(this).trigger("wc-product-gallery-after-init", [this, wc_single_product_params])
    })
