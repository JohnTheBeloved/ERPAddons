            ...
            if (typeof woocs_array_of_get.currency === 'undefined') {
                ...
                jQuery.post(woocs_ajaxurl, data, function(data) {
                    ...
                    if (!jQuery.isEmptyObject(data)) {
                        ...
                        if (woocs_drop_down_view == 'ddslick') {
                            try {
                                jQuery('select.woocommerce-currency-switcher').ddslick('select', {
                        ...
                        document.dispatchEvent(new CustomEvent('after_woocs_get_products_price_html', {
                            detail: {
...
function woof_init_orderby() {
    jQuery('form.woocommerce-ordering').life('submit', function() {
        ...
        console.log(57,{woof_current_values})
            /* woo3.3 */
...
function woof_get_submit_link() {
    ...
    console.log(JSON.stringify(woof_current_values))
...
function woof_radio_direct_search(term_id, name, slug) {
    ...
    if (slug != 0) {
        ...
        jQuery('woof_radio_term_' + term_id).parents('ul.woof_list').find('label').css({
            'fontWeight': 'normal'
        });
        jQuery('woof_radio_term_' + term_id).filter(':checked').parents('li').find('label.woof_radio_label_' + slug).css({
            'fontWeight': 'bold'
        });
    } else {
        jQuery('a.woof_radio_term_reset_' + term_id).hide();
