...
jQuery(document).ready(() => {
    ...
    new WishList(), new Checkout(), new WooCommon(), new LoadMore(), new ModalVideo("#productvideo"), new QuickView(), new DisplayMode(), new Shop(), new AjaxFilter(), new SingleProduct();
});
