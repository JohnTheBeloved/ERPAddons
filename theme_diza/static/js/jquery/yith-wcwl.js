jQuery(document).ready((function(t) {
    ...
    function o() {
        i(), e(), a(), n(), d(), s(), _(), l(), c(), r(), t(document).trigger("yith_wcwl_init_after_ajax")
    }
    ...
    function f(i) {
        var e = t(this),
            ...
            n = null;
        i.preventDefault(), (n = a.length ? e.closest("[data-wishlist-id]").find(".wishlist-title") : e.parents(".wishlist-title")).next().show().find('input[type="text"]').focus(), n.hide()
    }
    ...
    function u(i) {
        var e, a = t(this),
            ...
            d = s.val();
        if (i.preventDefault(), !d) return n.addClass("woocommerce-invalid"), void s.focus();
        e = {
            ...
            success: function(t) {
                var i = t.fragments;
                t.result ? (n.hide(), n.prev().find(".wishlist-anchor").text(d).end().show()) : (n.addClass("woocommerce-invalid"), s.focus()), void 0 !== i && T(i)
            }
        })
    }
    ...
    t(document).on("yith_wcwl_init", (function() {
        ...
        S.on("click", ".add_to_wishlist", (function(i) {
                ...
                if ((e = t(document).triggerHandler("yith_wcwl_add_to_wishlist_data", [a, d])) && (d = e), i.preventDefault(), jQuery(document.body).trigger("adding_to_wishlist"), yith_wcwl_l10n.multi_wishlist && yith_wcwl_l10n.modal_enable) {
                    var l = a.parents(".yith-wcwl-popup-footer").prev(".yith-wcwl-popup-content"),
                        c = l.find(".wishlist-select"),
                        r = l.find(".wishlist-name"),
                        _ = l.find(".wishlist-visibility").filter(":checked");
                    if (d.wishlist_id = c.is(":visible") ? c.val() : "new", d.wishlist_name = r.val(), d.wishlist_visibility = _.val(), "new" === d.wishlist_id && !d.wishlist_name) return r.closest("p").addClass("woocommerce-invalid"), !1;
                ...
                if ("new" === s && !l) return d.closest("p").addClass("woocommerce-invalid"), !1;
                d.closest("p").removeClass("woocommerce-invalid"), h({
                    wishlist_token: a,
            ...
            }(), s(), d(), l(), c(), _(), t(document).on("click", ".show-tab", (function(i) {
                var e = t(this),
            ...
            function() {
                ...
                t(window).on("resize", (function() {
                    var e = t(".wishlist_table.responsive"),
                        ...
                        s = e.closest("form"),
                        d = s.attr("class"),
                        l = s.data("fragment-options"),
                        c = {},
                        r = !1;
                    e.length && (n.matches && e && !a ? (l.is_mobile = "yes", r = !0) : !n.matches && e && a && (l.is_mobile = "no", r = !0), r && (i && i.abort(), c[d.split(" ").join(yith_wcwl_l10n.fragments_index_glue)] = l, i = t.ajax({
                        beforeSend: function() {
                            b(e)
                        },
                        complete: function() {
