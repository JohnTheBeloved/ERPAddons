odoo.define('diza_website.wishlist', function (require) {
"use strict";
        ...
        productReady.done(function (productId) {
            ...
            if (productId && !_.contains(self.wishlistProductIDs, productId)) {
                return self._rpc({
                    ...
                    $el.removeClass('single_add_to_wishlist')
                    $el.addClass('yith-wcwl-wishlistaddedbrowse')
                }).fail(function () {
                    console.log(2232, 'fail')
